...
class Search {
    ...
    const SEARCH_PLACES = [
        ...
        [
            self::F_SEARCH_HERE       => 1, // 1 -- искать в этой таблице
            self::F_TITLE             => "Пользователи",
            self::F_TABLE             => User::TABLE,
            self::F_SEARSH_IN_FIELDS  => [               User::F_NAME_FULL, User::F_NAME_SHORT, User::F_SURNAME, User::F_FAMILY, User::F_DESCRIPTION, "phone_main",   "mail_main",    "address_invoice", "jabber_main",  "viber",        "telegram",     "signal_messenger", "whatsapp"],
            self::F_SHOW_FIELDS       => ["id",          User::F_NAME_FULL, User::F_NAME_SHORT, User::F_SURNAME, User::F_FAMILY, User::F_DESCRIPTION, "phone_main",   "mail_main",    "address_invoice", "jabber_main",  "viber",        "telegram",     "signal_messenger", "whatsapp"],
            self::F_COL_TITLES        => ["User ID",     "name",            "name_short",       "Отчество",      "Фамилия",      User::F_DESCRIPTION, "Телефон",      "Эл. почта",    "Почтовый адрес",  "Jabber/XMPP",  "Viber",        "Telegram",     "Signal",           "WhatsApp"],
