    ...
    function listAction() {
        ...
        foreach ($module_list as &$module) {
            ...
            $t[] = [
                ...
                'title'     =>  "<div class='d-flex justify-content-between align-items-start'>"
                                    . "<div class='d-inline-flex align-items-center'>"
                                        . "<img src='".Icons::SRC_ICON_EDIT."' alt='[E]' width=22>&nbsp;"
                                        . "<a href='" . Module::URI_FORM . "/{$module[Module::F_ID]}'>"
                                        . "<span class='fs-5 text-info-emphasis'>{$module[Lang::code().Module::_TITLE]}</span><br>"
                                        . "</a>"
                                        . "<br>"
                                        . "<span class='small text-secondary'>{$module[Lang::code().Module::_DESCRIPTION]}</span>"
                                    . "</div>"
                                    . "<div>"
