...
class EmailController extends AppBaseController  {
     ...
     * @return bool
     */
    function registration(int $abon_id, array $to, string $subject, string $body): bool {
        ...
        $rec = [
            ...
            Notify::F_METHOD        => Notify::METHOD_EMAIL_LIST,
            Notify::F_SENDER_ID     => App::get_user_id(),
        ];

        $model = new AbonModel();
        $rez = $model->insert_row(Notify::TABLE, $rec);
