                ...
                <td>
                    ...
                    <?php if (count($a[Invoice::TABLE])): ?>
                        <?php foreach ($a[Invoice::TABLE] as $invoice): ?>
                            <a class="btn btn-sm btn-outline-success me-1 px-1 py-1" href="<?= Invoice::URI_EDIT ?>/<?= $invoice[Invoice::F_ID] ?>" target="_blank"><img src="<?= Icons::SRC_ICON_INV_ACT_SHTAMP ?>" alt="INVOICE" height="28pt">&nbsp;<?= $invoice[Invoice::F_INV_DATE_STR] ?></a><br>
                        <?php endforeach ?>
                    <?php else: ?>
                        <span class="text-nowrap">
                            <?php 
                            ...
                            ?>
                            <a class="btn btn-sm btn-outline-warning me-1 px-1 py-1" 
                                href="<?= Invoice::URI_EDIT ?>?<?= $query ?>"
                                title="<?= __('Создание нового счёта за услуги на текущий месяц'); ?>"
                                target="_blank"
                                ><img src="<?= Icons::SRC_ICON_INV_ACT_SHTAMP ?>" alt="INVOICE" height="28pt"> <?= __('Создать счёт') ?></a><br>
                        </span>
                        <br>
                    <?php endif; ?>
