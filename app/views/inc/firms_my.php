 ...
 *  File    : firms_my.php
 *  Path    : app/views/inc/firms_my.php
...
<div class="table-responsive">
    <table class="table table-striped table-hover align-middle mb-0">
        ...
        <tbody>
            <?php if (empty($my_firms)) : ?>
                <tr>
                    <td colspan="8" class="text-center text-muted py-3"><?= __('No entries | Нет записей | Немає записів') ?></td>
                </tr>
            <?php else: ?>
                <?php $rowNo = 0; ?>
                <?php foreach ($my_firms as $firm): ?>
                    <tr>
