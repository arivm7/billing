...
/**
 * количество прайсовых дней,
 * после пересечения которых снятие с паузы запрещено.
 * Можно только открывать новый прайсовый фрагмент клонированием
 */
...
enum PAStatus: int  {
    ...
    case ACTIVE         =                     self::CURRENT->value | self::FUTURE->value;
 // case ACTIVE_NOW     =                     self::CURRENT->value                       | self::PAUSE_TODAY->value;
    case ACTIVE_TODAY   =                     self::CURRENT->value | self::FUTURE->value | self::PAUSE_TODAY->value;
}
 ...
 *   AbonRest::F_SUM_PP30A    -- Активная абонплата за 30 дней
 *   AbonRest::F_SUM_PP01A    -- Активная абонплата за 1 день
 *   AbonRest::F_REST         -- Остаток на лицевом счету
 *   AbonRest::F_PREPAYED     -- Количество предоплаченных дней
